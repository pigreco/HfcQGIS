...
|[closest_point](closest_point.md)|Returns the point on a geometry that is closest to a second geometry|>=2.14
...
|[geometry_n](geometry_n.md)|Returns the nth geometry from a geometry collection, or null if the input geometry is not a collection|>=2.14
...
|[interior_ring_n](interior_ring_n.md)|Returns the geometry of the nth interior ring from a polygon geometry, or null if the geometry is not a polygon|>=2.14
...
|[is_closed](is_closed.md)|Returns true if a line string is closed (start and end points are coincident), false if a line string is not closed, or null if the geometry is not a line string|>=2.14
...
|[line_merge](line_merge.md)|s a (Multi-)LineString geometry, where any connected LineStrings from the input geometry have been merged into a single linestring.|>=2.18
|[m](m.md)|Returns the m value of a point geometry|>=2.14
|[make_circle](make_circle.md)|Crea un poligono circolare |**>=3.0**
|[make_ellipse](make_ellipse.md)|Crea un poligono ellittico |**>=3.0**
|[make_line](make_line.md)|Creates a line geometry from a series of point geometries|>=2.14
|[make_point](make_point.md)|Returns a point geometry from x and y (and optional z or m) values|>=2.14
|[make_point_m](make_point_m.md)|Returns a point geometry from x and y coordinates and m values|>=2.14
|[make_polygon](make_polygon.md)|Creates a polygon geometry from an outer ring and optional series of inner ring geometries|>=2.14
...
|[nodes_to_points](nodes_to_points.md)|Returns a multipoint geometry consisting of every node in the input geometry|>=2.14
|[num_geometries](num_geometries.md)|Returns the number of geometries in a geometry collection, or null if the input geometry is not a collection|>=2.14
|[num_interior_rings](num_interior_rings.md)|Returns the number of interior rings in a polygon or geometry collection, or null if the input geometry is not a polygon or collection|>=2.14
|[num_points](num_points.md)|Returns the number of vertices in a geometry|2.18
|[num_rings](num_rings.md)|Returns the number of rings (including exterior rings) in a polygon or geometry collection, or null if the input geometry is not a polygon or collection|>=2.14
...
|[point_on_surface](point_on_surface.md)|Returns a point guaranteed to lie on the surface of a geometry|>=2.14
...
|[relate](relate.md)|Tests or returns the Dimensional Extended 9 Intersection Model (DE-9IM) representation of the relationship between two geometries|>=2.14
|[reverse](reverse.md)|Reverses the direction of a line string by reversing the order of its vertices|>=2.14
|[segments_to_lines](segments_to_lines.md)|Returns a multi line geometry consisting of a line for every segment in the input geometry|>=2.14
|[shortest_line](shortest_line.md)|Returns the shortest line joining two geometries. The resultant line will start at geometry 1 and end at geometry 2|>=2.14
...
|[translate](translate.md)|Returns a translated version of a geometry. Calculations are in the Spatial Reference System of this geometry|>=2.14
...
|[z](z.md)|Returns the z coordinate of a point geometry|>=2.14
