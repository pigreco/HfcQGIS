...
|extend	Extend|s the start and end of a linestring geometry by a specified amount
...
|line_merge	Return|s a (Multi-)LineString geometry, where any connected LineStrings from the input geometry have been merged into a single linestring.
...
|segments_to|_lines	Returns a multi line geometry consisting of a line for every segment in the input geometry
...
|smooth	Smooths| a geometry by adding extra nodes which round off corners in the geometry
