...
grep -l -r -i --include \*.md '## Esempi' ./gr_funzioni >./gr_funzioni/elenco_funzioni318.txt
...
then reorder -f nome,valore,percentuale,bar ./gr_funzioni/elenco_funzioni318.txt >./gr_funzioni/quadro_sinottico318.md