...
grep -l -r -i --include \*.md '## Esempi' ./gr_funzioni >./gr_funzioni/elenco_funzioni314.txt
...
then reorder -f nome,valore,percentuale,bar ./gr_funzioni/elenco_funzioni314.txt >./gr_funzioni/quadro_sinottico314.md